...
const Staked: React.FunctionComponent<StackedActionProps> = ({
  ...
  console.log('debug->userdataready', userDataReady)
  ...
  let stakeVal = displayBalance();
  if(pid === 1){
    stakeVal = new BigNumber(stakeVal).toLocaleString();
  }
  else if(pid === 0){
    stakeVal = new BigNumber(stakeVal).times(BIG_TEN.pow(9)).toFixed(3, BigNumber.ROUND_DOWN).toLocaleString();
  }
